 ...
 * @covers     \aiprovider_ai_manager\provider
 * @covers     \aiprovider_ai_manager\process_summarise_text
 * @covers     \aiprovider_ai_manager\abstract_processor
 */
final class process_summarise_text_test extends \advanced_testcase {
    ...
    protected function setUp(): void {
        ...
        $this->responsebodyjson = file_get_contents(self::get_fixture_path('aiprovider_ai_manager', 'text_request_success.json'));
