 ...
 * @covers     \aiprovider_ai_manager\process_generate_image
 */
final class process_generate_image_test extends \advanced_testcase {
    ...
    protected function setUp(): void {
        ...
        $this->responsebodyjson = file_get_contents(self::get_fixture_path('aiprovider_ai_manager', 'image_request_success.json'));
    ...
    private function create_provider(): void {
        ...
        $this->provider = $this->manager->create_provider_instance(
            classname: '\aiprovider_ai_manager\provider',
            name: 'dummy',
            config: $config,
        );
    }
    ...
    public function test_query_ai_api_success(): void {
        ...
        $mock->append(new Response(
            ...
            \GuzzleHttp\Psr7\Utils::streamFor(fopen(
                self::get_fixture_path('aiprovider_ai_manager', 'test.jpg'),
                'r',
            )),
        ));
    ...
    public function test_process(): void {
        ...
        $mock->append(new Response(
            200,
            ['Content-Type' => 'image/jpeg'],
            \GuzzleHttp\Psr7\Utils::streamFor(fopen(self::get_fixture_path('aiprovider_ai_manager', 'test.jpg'), 'r')),
        ));
